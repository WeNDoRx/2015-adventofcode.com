...
def bruteforce():
	...
	for cups in quantities:
		...
		score, capacity, durability, flavor, texture, calories, ingredient_nr = (0,)*7
		...
		for ingredient in ingredients:
			...
			calories += cups[ingredient_nr] * ingredients[ingredient][4]
		...
		# but if any attribute < 0, score = 0 OR calorise != 500
